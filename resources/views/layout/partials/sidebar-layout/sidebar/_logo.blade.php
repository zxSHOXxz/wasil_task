...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
    ...
    <a href="{{ route('dashboard') }}"
        style="text-decoration: none; font-size: 19px;font-weight: 600;color: #252F4A;font-family: Inter, Helvetica, sans-serif;gap: 12px;"
        class="d-flex">
        <img alt="Logo" src="{{ image('logos/default-small.svg') }}" class="h-25px app-sidebar-logo-default" />
